...
class PaperSectionAdmin(admin.ModelAdmin):
    list_display = ['title', 'paper', 'order']
    list_filter = ['paper']
    search_fields = ['title', 'description']
...
class ExamSubmissionAdmin(admin.ModelAdmin):
    list_display = ['student', 'paper', 'is_submitted', 'is_graded', 'graded_score', 'started_at', 'submitted_at']
    list_filter = ['is_submitted', 'is_graded', 'paper']
